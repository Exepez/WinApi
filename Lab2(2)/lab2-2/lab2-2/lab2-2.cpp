...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_USER + 1:
	{
		MessageBox(hWnd, _T("Окно 1 прислало сообщение WM_USER+1!"), _T("Сообщение принято"), MB_OK);
		return DefWindowProc(hWnd, message, wParam, lParam);
	}
	case WM_USER + 2:
	{
		MessageBox(hWnd, _T("Окно 1 прислало сообщение WM_USER+2. Выключение"), _T("Сообщение принято"), MB_OK);
